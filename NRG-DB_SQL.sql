...
(
    ...
    Office VARCHAR(30),
	Skills VARCHAR(30),
	Current_Work VARCHAR(30),
	Booked_Leave VARCHAR(30),
	Leave VARCHAR(30),
	Personal_Leave VARCHAR(30),
    PRIMARY KEY (id)
);

INSERT INTO Employee_Contact_Info
(Employee_Number,Surname, First_Name, DOB, Phone_Number, Email)
VALUES
...
(Employee_Number,First_Day, Office, Skills, Current_Work, Booked_Leave, Leave,Personal_Leave)
VALUES
